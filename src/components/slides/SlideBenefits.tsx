      ...
      <div className="grid md:grid-cols-3 gap-8">
        <div className="glass-card p-8 flex flex-col items-center text-center gap-4 animate-fade-in" style={{ animationDelay: "0.1s" }}>
          ...
          <p className="text-muted-foreground text-sm leading-relaxed">
            Możliwość zwiększenia popularności kanału poprzez zachęcanie naszych użytkowników z innych społeczności o podobnej tematyce do poznania Twojego kanału.  
          </p>
        </div>
